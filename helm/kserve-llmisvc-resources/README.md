...
```console
$ helm install kserve-llmisvc-resources oci://ghcr.io/kserve/charts/kserve-llmisvc-resources --version [[ .Version ]]
```
...
| kserve.agent.image | string | `"gsoci.azurecr.io/giantswarm/agent"` |  |
| kserve.agent.tag | string | `""` |  |
| kserve.router.image | string | `"gsoci.azurecr.io/giantswarm/router"` |  |
...
| kserve.storage.image | string | `"gsoci.azurecr.io/giantswarm/storage-initializer"` |  |
...
| kserve.localmodel.controller.image | string | `"gsoci.azurecr.io/giantswarm/kserve-localmodel-controller"` |  |
...
| kserve.localmodel.defaultJobImage | string | `"gsoci.azurecr.io/giantswarm/storage-initializer"` |  |
...
| kserve.localmodel.agent.image | string | `"gsoci.azurecr.io/giantswarm/kserve-localmodelnode-agent"` |  |
...
| kserve.llmisvc.controller.image | string | `"gsoci.azurecr.io/giantswarm/llmisvc-controller"` |  |
...
| kserve.llmisvc.controller.serviceMonitor.enabled | bool | `false` |  |
| kserve.llmisvc.controller.serviceMonitor.interval | string | `"60s"` |  |
| kserve.llmisvc.controller.serviceMonitor.labels | object | `{}` |  |
